...
export default function Sidebar() {
  ...
  return (
    <div
      id="sidebar"
      className="flex flex-col min-h-screen w-80 bg-white p-8 shadow-lg"
    >
      {/* Logo */}
      <div id="sidebar-logo" className="flex flex-col mb-10">
        <span
          id="logo-title"
          className="font-poppins text-[48px] text-gray-900 font-bold leading-none"
        >
          Sedap
        ...
        <ul id="menu-list" className="space-y-3">
          ...
          <li>
            <NavLink to="/FiturXyz" className={menuClass}>
              <FaBars className="mr-4 text-xl" /> XYZ
            </NavLink>
          </li>
          <li>
            <NavLink to="/notes" className={menuClass}>
              <FaStickyNote className="mr-4 text-xl" /> Notes
            </NavLink>
          </li>
          <li>
      ...
      <div id="sidebar-footer" className="mt-auto">
        <div
          id="footer-card"
          className="bg-hijau px-4 py-4 rounded-xl shadow-lg mb-6 flex flex-col items-center"
        >
          ...
          <div
            id="add-menu-button"
            className="flex justify-center items-center p-2 bg-white rounded-md space-x-2 text-gray-600 w-full cursor-pointer hover:bg-gray-100"
          >
