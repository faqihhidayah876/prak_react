...
-- Jalankan setelah migration utama sudah di-run
-- ============================================================
...
-- Update role admin untuk user yang sudah login (ganti email sesuai akun kamu)
-- UPDATE profiles SET role = 'admin' WHERE email = 'faqih@email.com';